---
title: "ADU cash flow: why monthly rent is not the answer"
...
status: "published"
featured: true
cta: "Compare collected rent with expenses, debt payments, and the cash needed before opening."
---
...
1. How much additional cash could the project require at its peak?
2. How does modeled monthly cash flow change after the ADU is operating?
3. How sensitive is that result to rent, cost, interest rate, and delay?
4. Does the longer-term gain compensate for the cash and risk required?

Put With ADU, Without ADU, and ADU impact side by side in your worksheet so a large rent number cannot hide the rest of the model. Read [how to build a defensible rent comp set](/blog/how-much-does-an-adu-rent-for/) before choosing the income assumption.
## Sources checked September 4, 2026

- [HUD Fair Market Rents](https://www.huduser.gov/portal/datasets/fmr.html)
- [CFPB home-equity loan and HELOC comparison](https://www.consumerfinance.gov/ask-cfpb/what-is-the-difference-between-a-home-equity-loan-and-a-home-equity-line-of-credit-heloc-en-247/)
